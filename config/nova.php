...
return [
    ...
    */
    ...
    'path' => '/nova_' . env('NOVA_SECURE_SUFFIX', 'abcde12345'),
    ...
    */
    ...
    'brand' => [
//        'logo'   => resource_path('/img/laravel-logo.svg'),
        'colors' => [
            "400" => "24, 182, 155, 0.5",
            "500" => "24, 182, 155",
            "600" => "24, 182, 155, 0.75",
...
//        'colors' => [
//            "400" => "235, 200, 70, 0.5",  // 50% opacity darker yellow
//            "500" => "235, 200, 70",       // Solid darker yellow
//            "600" => "235, 200, 70, 0.75", // 75% opacity darker yellow
//        ],
    ],
